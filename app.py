...
# --- 1. BOOTSTRAPPER (Fixes missing browser error) ---
# Playwright needs its browser binaries in the local cache
    ...
    if not uploaded_files or not url:
        ...
        try:
            with sync_playwright() as p:
                # Optimized launch args for cloud environments
